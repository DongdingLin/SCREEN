    ...
    def launch(self, max_steps: int = None, interactive: bool = True, show_description: bool = True, show_message: bool = True):
        ...
        if show_description:
            ...
            for i, player in enumerate(players):
                ...
                console.print("\n----In Transition Turn---- Role Description:")
                if player.role_desc_in_transition_turn is not None:
                    console.print(player.role_desc_in_transition_turn)
                console.print("\n----After Transition Turn---- Role Description:")
                if player.role_desc_after_transition_turn is not None:
                    console.print(player.role_desc_after_transition_turn)
        if show_message:
            console.print("\n========= Arena Start! ==========\n", style="bold green")
